 ...
 *         &lt;element name="part" type="{http://hl7.org/fhir}Parameters.Part" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Element
{
    ...
    protected List<ParametersPart> part;
     ...
     * 
     */
    public List<ParametersPart> getPart() {
        if (part == null) {
            part = new ArrayList<ParametersPart>();
        }
        return this.part;
    }
