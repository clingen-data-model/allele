...
ReferenceSequence is abstract: actual instances must be either a [ChromosomeReferenceSequence](chromosome_reference_sequence.html), a [GeneReferenceSequence](gene_reference_sequence.html), a [TranscriptReferenceSequence](transcript_reference_sequence.html), or a [ProteinReferenceSequence](protein_reference_sequence.html) .
